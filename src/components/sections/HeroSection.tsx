  ...
  return (
    <section className="relative flex min-h-screen items-center justify-center">
      ...
      <div className="relative z-10 mx-auto max-w-3xl px-6 text-center">
        <p className="text-sm font-semibold tracking-[0.2em] uppercase text-white/80 text-center">
          {t("label")}
        </p>
        ...
        <p className="mt-6 text-xl leading-relaxed text-white/70 text-center">
          {t("subtitle")}
        </p>
        <div className="mt-10">
